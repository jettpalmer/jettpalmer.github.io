...
::: {.project-links}
[Visit Thesis Website](https://jettpalmer.github.io/design-for-impact/){.btn .btn-primary}
...
*Design For Impact: The Statistical Collaborator's Workflow* is my master’s thesis project focused on improving how statisticians and domain experts plan for real-world impact in collaborative projects. The project introduces the Design For Impact Tool, a fillable framework that helps teams align on goals, define a decision-focused intended impact, connect analysis choices to that impact, and communicate results in ways that support action.
...
::: {.deliverable-card}
**Thesis Website**  
A public-facing website introducing the Design For Impact Tool, the motivation behind the project, and the research process supporting the framework.
