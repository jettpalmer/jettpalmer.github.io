...
![Winner: Best Visualization of Cal Poly DataFest 2024](bestVisualization.png){fig-alt = "Four panes with six cool colored box plots with corresponding density ridge plots. Chapter reflection score is the response variable and reflection score is the explanatory variable. Each pane represents a psychological construct that the reflection score was measuring."}
